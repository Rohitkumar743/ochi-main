    ...
    >
      <div className="container w-full">
        <h1 className="sm:text-3xl text-xl sm:leading-normal font-medium mb-10 border-b-[1px] border-zinc-700 pb-10">
          Lorem ipsum dolor sit amet consectetur adipisicing elit. Vero nihil dolorem soluta molestiae magni quae ab, laboriosam ad quia labore.
        </h1>
        <div className="md:flex justify-center gap-10">
          <div className="about-text h-fit">
            ...
            <p className="text-base sm:text-xl text-zinc-200 tracking-wide">
              Lorem ipsum, dolor sit amet consectetur adipisicing elit. Accusamus, officiis ad doloribus iste voluptatum alias necessitatibus molestias voluptate natus! Ab rem eligendi vel minus magni non saepe dolores consectetur accusamus.
            </p>
